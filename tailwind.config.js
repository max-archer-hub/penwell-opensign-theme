...
module.exports = {
  ...
  daisyui: {
    ...
    themes: [
      ...
      {
        // PW-014a2a -- Penwell Law reskin. "opensigncss" is the app's designated
        // light/default theme SLOT (not renamed -- 8 files reference the literal
        // string "opensigncss", incl. ThemeToggle.jsx and index.html's data-theme
        // attribute; repainting this slot's values avoids touching all of them).
        // Palette sourced directly from the live site (site/index.html's :root
        // custom properties in the penwell-law repo), not a separate plan doc.
        // info/success/warning/error kept as OpenSign's own sane semantic
        // defaults -- the editorial palette has no reds/greens/blues of its own,
        // and a recognizable green "success" / red "error" is the right call
        // for a signing app regardless of brand, so those are deliberately NOT
        // repainted gold/navy.
        opensigncss: {
          primary: "#11203A", // --ink
          "primary-content": "#FAF7F0", // --paper
          secondary: "#7A6224", // --gold-deep
          "secondary-content": "#FAF7F0", // --paper
          accent: "#B8943E", // --gold
          "accent-content": "#11203A", // --ink
          neutral: "#3C4A63", // --ink-soft
          "neutral-content": "#F3EEE3", // --paper-2
          "base-100": "#FAF7F0", // --paper
          "base-200": "#F3EEE3", // --paper-2
          "base-300": "#DDD5C7", // --border (already defined in the site's own legacy variable map)
          "base-content": "#11203A", // --ink
          info: "#00b6ff",
          "info-content": "#f5f5f4",
          success: "#00a96e",
          ...
          // Sharp, not rounded -- matches the site's deliberate border-radius:2px
          // editorial aesthetic (only the circular seal logo is an exception).
          "--rounded-btn": "2px",
          "--tab-border": "2px",
          "--tab-radius": "2px"
        }
